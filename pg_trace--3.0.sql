...
-- Version 3.0 - Added statistics and views
...
-- Returns: query_text text, duration_us bigint, start_time timestamptz, end_time timestamptz
...
-- Returns: total_queries bigint, total_duration_us bigint, avg_duration_us bigint, 
--          max_duration_us bigint, min_duration_us bigint
...
-- View for quick statistics access
...
SELECT 
    ...
    min_duration_us,
    CASE 
        WHEN total_duration_us > 1000000 THEN round(total_duration_us::numeric / 1000000, 3) || ' s'
        WHEN total_duration_us > 1000 THEN round(total_duration_us::numeric / 1000, 3) || ' ms'
        ELSE total_duration_us || ' us'
    END AS total_duration_formatted,
    CASE 
        WHEN avg_duration_us > 1000000 THEN round(avg_duration_us::numeric / 1000000, 3) || ' s'
        WHEN avg_duration_us > 1000 THEN round(avg_duration_us::numeric / 1000, 3) || ' ms'
